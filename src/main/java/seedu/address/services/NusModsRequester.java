...
public class NusModsRequester {
    ...
    private static final String fileNotFoundMsg = "The specified module could not be found on NUS Mods. Please remove the " + CliSyntax.FLAG_AUTO + " flag and add the file manually";
    ...
    private static String getUrlPath(String academicYear, String moduleCode){
        return Routes.NUS_MODS_ROOT + "/" + academicYear + "/" + Routes.NUS_MODS_MODULES_DIR + "/" + moduleCode.toUpperCase() + "/" + Routes.NUS_MODS_INDEX_JSON;
    }
