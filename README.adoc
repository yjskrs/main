...
2. course edit: [n/COURSE_NAME] [u/MCs]

3. course delete n/COURSE_NAME
----
 ...
 */
course edit: n/Information Systems, u/140
...
2. `course delete`: Removing a course removes all data from the system (including modules, requirements, etc)
====

Expected Outcome
[NOTE]
You should be able to see the created and edited course name in the
...
Creates a graduation requirement category.
...
2. requirement edit n/REQUIREMENT_NAME: [n/REQUIREMENT_NAME] [u/NO_OF_MCS]

3. requirement delete n/REQUIREMENT_NAME: [n/REQUIREMENT_NAME] [u/NO_OF_MCS]
----
...
----
/*
 * Creating a requirement named "Unrestricted Electives" which
 * requires 32 MCs to fulfill
 */
requirement add n/Unrestricted Electives: u/32

/*
 * Renaming a requirement named "Unrestricted Electives", and
 * changing the number of MCs to 20 (to fulfill)
 */
requirement edit n/Unrestricted Electives: u/32

/*
 * Removes a requirement named "Unrestricted Electives"
 */
requirement delete n/Unrestricted Electives
----
