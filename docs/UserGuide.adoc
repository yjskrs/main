...
----
assign REQUIREMENT_NAME n/MODULE_CODE, t/MODULE_TITLE u/MCs; ...
----

Command Sample

Assigns (and creates) a module "LAJ1201" (4 MCs) and another module "CS1101S" (4 MCs) to the requirement
