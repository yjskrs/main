...
(Nathanael)
____
This segment highlights the three key features iGrad offers to NUS students, namely;
a Course Planner, an Module Credits (MCs) Tracker, and a Cummulative Average Point (CAP) Tracker.
...
a course of your own dreams, be it those of you doing a _single degree programme_,
a _double degree programme_, and even a _concurrent degree programme_.

With our course planner, you would be able to enter your current course details such as your
*modules* and the various broad degree *requirements* by which those modules are mapped.

For instance, in the _Computer Science_ course (as shown in the _Figure
...
We are sick of counting our MCs at the beginning of every semester, be it our total course MCs left before
we can apply for graduation, or maybe the MCs for those invidual requirements. Our MCs feature allows you
to easily keep track of these information, at your fingertips.

==== CAP Tracker

No more googling for CAP calculators. iGrad's CAP tracker helps you keeps track of your CAP at
every step of your journey in your course, and it even offers predictive features so you know how
well you have to do in order to achieve your dream CAP.

==== Everything Integrated in One Application
But the best part about these features, is that they are all in one application; iGrad. Hence, with all
these important pieces of information in one place, you would never go amiss keeping track
of your graduation requirements.

== Components
(Nathanael)
____
This segment details various components of our application; iGrad. As shown in the picture below,
the components follows a hierachical structure.
...
and total number of MCs towards graduataion.
...
a grade. You could also add optional memos to help you remember why
you took the module.
...
Here is a 10-step guide to use `iGrad`.
