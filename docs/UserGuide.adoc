...
the Course Planner, an Module Credits (MCs) Tracker, and a Cummulative Average Point (CAP) Tracker.
____

==== Course Planner
iGrad was built with every NUS student in mind. Our flexible course planner allows you to plan
the course of your own dreams, be it those of you doing a single degree programme,
a minor programme, a double degree programme, and even those from the concurrent degree programme.
With our course planner, you would be able to enter
...
Finally, the best part about these features, are that they are all in one app; iGrad. With all
information in one place, you would never go amiss keeping track of your graduation requirements.

== Components
(Nathanael)
____
This segment contains details of the application's components and entities of iGrad.
____
