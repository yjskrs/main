...
Now, to describe more of this `CourseInfo` class, its fields, the following two sections would
...
** The user has already set a course, through the xref:anchor-tag-e[`course set`] command.
...
This feature allows students to mark a module with a certain grade when she has completed
a module.
===== Implementation
