...
Step 1: The CourseEditCommandParser is called to parse the CourseEditCommand with the `n/` and `s/` prefix.

Step 2: The CourseEditCommand is executed to set the new course name and course semesters to the model.

Step 3: The new course name and course semesters is set in the course book.
...
Step 1: The CourseAchieveCommandParser is called to parse the CourseAchieveCommand with the `c/` prefix.

Step 2: The CourseAchieveCommand is executed and it calls CourseInfo to calculate estimated cap.

Step 3: The result is passed back to the user.
