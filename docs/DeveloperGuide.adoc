...
|`RequirementCode` |The unique identifier of a requirement. |CSF0
...
* `requirement add` - adds a new requirement to the course
* `requirement edit` - edits an existing requirement in the course
* `requirement delete` - deletes an existing requirement from the course
