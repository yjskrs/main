...
This command allows users of the CourseBook application to add optional remarks to people in their course book and edit it if required.
...
/**
 * Changes the remark of an existing module in the course book.
 */
...
Not doing so will cause CourseBook to default to an empty course book!
