...
.  Update the link to the 'build status' badge at the top of the `README.md` to point to the build status of your own repo.
...
.  Go to the URL `\https://<your-username-or-organization-title>.github.io/addressbook-level3/index.html`. You should see your `README` file displayed.
