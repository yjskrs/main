...
*** Besides that, other merge conflicts I helped resolved while merging are;
...
** Managed the issue tracker for the first-half of this project, creating and assigning issues
to track the progress of my teamates
...
** Provided PR code reviews to my team members on how potential things they could improve
and work on, as I merged their PRs
